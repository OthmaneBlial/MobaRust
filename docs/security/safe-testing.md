...
policy distinguishes single-line input from CR/LF/Unicode multiline input
while requiring confirmation by default. It does not open a browser, invoke
Tauri, or contact a remote host.
