...
<p align="center">
  <a href="https://github.com/OthmaneBlial/MobaRust/blob/main/LICENSE"><img src="https://img.shields.io/static/v1?label=license&message=Apache%202.0&color=2ea44f&style=flat-square&logo=apache&logoColor=white" alt="Apache License 2.0" /></a>
...
| **X11** | Explicit SSH forwarding to a configured external display, with a disposable real-X11 loopback fixture when Xvfb is already installed; an integrated cross-platform X server remains a separate research and packaging decision |
