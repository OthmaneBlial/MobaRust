...
- RDP/VNC helper-pipe writes have a dedicated deadline; failures become one redacted crash diagnostic, and reader exits trigger bounded helper cleanup/reaping.
