...
- a global transfer-manager view that aggregates SFTP/SCP jobs across SSH sessions, exposes source/destination paths, progress, native speed and ETA estimates, and keeps cancellation explicit;
...
- a versioned, bounded RDP/VNC helper-process contract with lifecycle and
  ...
  clients until signing, clean-install, and interoperability gates pass.
