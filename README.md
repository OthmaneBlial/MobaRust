...
| **Operator tools** | Snippets with preview, visible macros, explicit multi-exec targets, network diagnostics, bounded port checks, remote monitoring, privacy-conscious audit history, and sanitized diagnostic export |
