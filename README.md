...
- RDP/VNC helper-pipe writes have a dedicated deadline; failures become redacted crash diagnostics, and reader exits trigger bounded helper cleanup/reaping.
