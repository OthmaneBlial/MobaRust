...
- RDP/VNC helper-pipe writes have a dedicated deadline; VNC protocol input and refresh writes also have a two-second bound, failures become one redacted crash diagnostic, and reader exits trigger bounded helper cleanup/reaping.
