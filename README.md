...
| **X11** | Explicit SSH forwarding to a configured external display, with a disposable real-X11 local fixture when Xvfb is already installed; an integrated cross-platform X server remains a separate research and packaging decision |
