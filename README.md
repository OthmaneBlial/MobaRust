...
| **VNC** | Native helper with local RFB fixtures, authentication, framebuffer updates, protocol-aware keyboard/mouse input, explicit clipboard opt-in enforced at both native boundaries, scaling, quality profiles, bounded configurable reconnect, cancellation, and clean shutdown; broader interoperability remains open |
