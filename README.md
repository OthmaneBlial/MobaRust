...
| **VNC** | Native helper with local RFB fixtures, authentication, raw/copy/Tight-JPEG framebuffer updates, bounded keyboard/mouse input, explicit clipboard opt-in enforced at both native boundaries, scaling, quality profiles, bounded configurable reconnect, cancellation, and clean shutdown; broader interoperability remains open |
